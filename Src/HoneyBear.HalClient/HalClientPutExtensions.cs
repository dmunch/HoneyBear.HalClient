namespace HoneyBear.HalClient
{
    ...
    /// <summary>
    /// Extension methods implementing HTTP PUT operations
    /// </summary>
    public static class HalClientPutExtensions
    {
        /// <summary>
        ...
        public static IHalClient Put(this IHalClient client, string rel, object value) =>
            client.Put(rel, value, null, null);
        ...
        /// <returns>A new instance of <see cref="IHalClient"/> with updated resources.</returns>
        /// <exception cref="FailedToResolveRelationship" />
        public static IHalClient Put(this IHalClient client, string rel, object value, string curie) => 
            client.Put(rel, value, null, curie);
        ...
        public static IHalClient Put(this IHalClient client, string rel, object value, object parameters) => 
            client.Put(rel, value, parameters, null);
        ...
        /// <exception cref="FailedToResolveRelationship" />
        /// <exception cref="TemplateParametersAreRequired" />
        public static IHalClient Put(this IHalClient client, string rel, object value, object parameters, string curie)
        {
            var relationship = HalClientExtensions.Relationship(rel, curie);

            return client.BuildAndExecute(relationship, parameters, uri => client.Client.PutAsync(uri, value));
        }
